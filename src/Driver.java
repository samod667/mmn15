...
//        System.out.println("\n************************ MMN 15 TEST END **************************");
        ...
        IntNode num1 = new IntNode(900251);
        IntNode num2 = new IntNode(891099);

        BigNumber big1 = new BigNumber(num1.getValue());
        BigNumber big2 = new BigNumber(num2.getValue());

        BigNumber big3 = new BigNumber(1000);
        BigNumber big4 = new BigNumber(999);

//        System.out.println(big3.subtractBigNumber(big4));
        System.out.println(big1.subtractBigNumber(big2));
